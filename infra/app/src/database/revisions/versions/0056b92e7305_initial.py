...
Revision ID: 0056b92e7305
Revises: 
Create Date: 2026-01-09 16:36:47.831550
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_action_active'), 'action', ['active'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_table('user')
    op.drop_index(op.f('ix_action_active'), table_name='action')
